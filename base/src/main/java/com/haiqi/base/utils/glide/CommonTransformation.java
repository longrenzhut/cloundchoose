 ...
 */
public class CommonTransformation implements  Transformation<Bitmap> {
    ...
    public CommonTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public CommonTransformation(BitmapPool pool, int radius, int margin) {
